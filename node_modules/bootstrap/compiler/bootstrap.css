...
.btn:not(:disabled):not(.disabled):active:focus, .btn:not(:disabled):not(.disabled).active:focus {
  box-shadow: 0 0 0 0.2rem rgba(102, 102, 102, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125);
}
...
.custom-select:focus {
  border-color: #a6a6a6;
  outline: 0;
  box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(102, 102, 102, 0.25);
}
...
.custom-range::-webkit-slider-thumb:active {
  background: #bfbfbf linear-gradient(180deg, #c9c9c9, #bfbfbf) repeat-x;
}
